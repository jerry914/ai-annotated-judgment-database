<template>
  <div class="container mt-4">
    <div class="intro-containter border rounded-3">
      本系統是國立清華大學人文社會AI應用與發展研究中心為執行AI公共化相關計畫之成果展示，以司法院所公開的民刑事案件判決書為訓練資料，讓生成式AI模型自動標註出與該案件有關的法官見解、法官心證與法官涵攝的相關文字，免費對外開放，提供法學研究者、司法實務工作者或一般民眾使用。
      <br><br>
      由於民刑事案件的資料取得日期、模型訓練的時間和方式皆有不同，而其中見解資料也特別增加AI自動分辯「類似見解」的功能，需要十餘秒的計算時間，所以目前測試版先以不同方式呈現搜尋結果。未來將再更新模型與資料，提供更完整與更實用的成果展現。
    </div>
    <el-row>
